...
def test_scalebar_rejects_zero_size_image() -> None:
    with pytest.raises(ValueError, match="non-zero height and width"):
        imgviz.scalebar(np.zeros((10, 0, 3), dtype=np.uint8), pixels_per_unit=1)
